...
{/* 		
	...
	<div className="bg-white">
		...
		<div className="relative bg-gray-900">
			...
			<img src="https://tailwindui.com/img/ecommerce-images/home-page-01-hero-full-width.jpg" alt="" className="w-full h-full object-center object-cover"/>
			</div>
...
<footer className="bg-black">
  <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div className="flex justify-center space-x-6 md:order-2">
      ...
      <a href="https://www.instagram.com/emanueljuarez/" className="text-gray-400 hover:text-gray-500">
      ...
      <a href="https://github.com/emjuarez" className="text-gray-400 hover:text-gray-500">
    ...
    <div className="mt-8 md:mt-0 md:order-1">
      <p className="text-center text-base text-gray-400">&copy; Made by Emanuel Juárez. All rights reserved.</p>
    </div>
  </div>
</footer>
